  ...
  function s(o, u) {
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      var vm = new Vue({
        ...
        methods: {
          changeDesigner: function changeDesigner(item, status) {
            axios.get("/index/admin/change_designer", {
              params: {
                uid: item.id,
                status: status
              }
          ...
          getUserList: function getUserList() {
            ...
            axios.get("/index/admin/get_user_list", {
              params: {
                page: this.page
              }
            }).then(function (res) {
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_548aa03f.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);