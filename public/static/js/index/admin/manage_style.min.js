...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var vm = new Vue({
        ...
        methods: {
          deleteStyle: function deleteStyle(id) {
            axios.get("/index/admin/delete_style", {
              params: {
                id: id
              }
            }).then(function (res) {
          ...
          //获取名字
          getStyleName: function getStyleName(value, type) {
            var returnValue = '';
            if (this.styleTypeList[type]) {
              this.styleTypeList[type].forEach(function (item, index) {
                if (item['id'] === value) {
          ...
          //编辑款式
          openEditBox: function openEditBox(id) {
            this.editBoxFlag = 1;

            var tmpEditValue = void 0;
            this.styleList.forEach(function (item, index) {
              if (item.id == id) {
                tmpEditValue = item;
              }
            });
          ...
          //提交款式编辑
          submitStyleEdit: function submitStyleEdit() {
            if (this.editBoxValue.sex && this.editBoxValue.color && this.editBoxValue.style && this.editBoxValue.price && this.editBoxValue.cost && this.editBoxValue.material) {
              axios.get("/index/admin/edit_cloth_style", {
          ...
          getStyleList: function getStyleList() {
            ...
            axios.get("/index/index/get_style_list").then(function (res) {
              if (res.data) {
          ...
          //获得款式信息
          getStyleTypeList: function getStyleTypeList() {
            var _this2 = this;

            axios.get("/index/index/get_style_param").then(function (res) {
              _this2.styleTypeList = res.data;
              _this2.getStyleList();
            });
          },
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_44ee8ebf.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);