...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var vm = new Vue({
        ...
        methods: {
          ...
          deleteLabel: function deleteLabel(item) {
            ...
            axios.get("/index/admin/delete_tag", {
              params: {
                id: item.id
              }
            }).then(function (res) {
          ...
          saveTag: function saveTag(item) {
            ...
            axios.get("/index/admin/save_tag", {
              params: {
                id: item.id,
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_e8343efc.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);