...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var vm = new Vue({
        ...
        methods: {
          ...
          initData: function initData() {
            ...
            axios.get("/index/admin/get_home_image_list").then(function (res) {
              var data = res.data;
              _this.homeList = data.data;
              for (var i = 0; i < _this.homeList.length; i++) {
                _this.homeShow.push('true');
              }
              console.log(_this.homeList);
              console.log(_this.homeShow);
            });
          },
          addBanner: function addBanner() {
            console.log(this.form);
            axios.get("/index/admin/add_home_image_list", {
              params: {
                id: this.form.id,
          ...
          confirmBanner: function confirmBanner(index) {
            console.log(this.homeList);
            this.homeShow[index] = false;
          ...
          deleteBanner: function deleteBanner(index) {
            var deleteId = this.homeList[index].id;
            console.log(deleteId);
            axios.get("/index/admin/delete_home_image", {
              params: {
                id: deleteId
              }
            }).then(function (res) {
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_b88f38e4.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);