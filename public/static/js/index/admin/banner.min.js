...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var vm = new Vue({
        ...
        methods: {
          ...
          initData: function initData() {
            ...
            axios.get("/index/admin/get_banner_list").then(function (res) {
              var data = res.data;
              _this.bannerList = data.data;
              for (var i = 0; i < _this.bannerList.length; i++) {
                _this.bannerShow.push('true');
              }
              console.log(_this.bannerList);
              console.log(_this.bannerShow);
            });
          },
          addBanner: function addBanner() {
            console.log(this.form);
            axios.get("/index/admin/add_banner", {
              params: {
                id: this.form.id,
          ...
          deleteBanner: function deleteBanner(index) {
            ...
            axios.get("/index/admin/delete_banner", {
              params: {
                id: deleteId
              }
            }).then(function (res) {
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_89e5f82b.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);