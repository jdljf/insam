      ...
      var vm = new Vue({
        ...
        methods: {
          createCoupon: function createCoupon() {
            ...
            axios.get("/index/admin/create_coupon", {
              params: {
          ...
          timeSelect: function timeSelect(type) {
            this.expiry.expire_type = type;
          },
          getCouponType: function getCouponType(val) {
            var coupon = this.$refs.couponSelect;
            this.coupon_limit = coupon.value;
            if (this.coupon_limit == 2) {
              var styleId = this.$refs.styleItem;
          ...
          styleSelect: function styleSelect() {
            var styleId = this.$refs.styleItem;
            this.style_id = styleId.value;
          }
        },
        mounted: function mounted() {
          ...
          this.$nextTick(function () {
            var style = _this3.$refs.styleItem.value;
            var coupon = _this3.$refs.couponSelect;
            _this3.coupon_limit = coupon.value;
          });
        }
      });
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_36fff2ee.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);