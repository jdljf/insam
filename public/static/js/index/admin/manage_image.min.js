...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var vm = new Vue({
        ...
        methods: {
          deleteImage: function deleteImage(id) {
            axios.get("/index/admin/delete_image", {
              params: {
                id: id
              }
            }).then(function (res) {
          ...
          changeLabel: function changeLabel(e) {
            if (this.labelTmp) {
          ...
          submitStyleEdit: function submitStyleEdit() {
            if (this.editBoxValue.price && this.editBoxValue.image) {
              axios.get("/index/admin/edit_image", {
          ...
          getImageList: function getImageList() {
            ...
            axios.get("/index/admin/get_image").then(function (res) {
              if (res.data) {
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_eae4b5e4.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);