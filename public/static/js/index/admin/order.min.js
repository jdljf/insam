...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var vm = new Vue({
        ...
        methods: {
          getOrderList: function getOrderList() {
            ...
            axios.get("/index/admin/get_order_list", {
              params: {
          ...
          changeOrderStatus: function changeOrderStatus(orderId, status) {
            axios.get("/index/admin/change_order_status", {
              params: {
                status: status,
                id: orderId
              }
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_8edc929e.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);