      ...
      var vm = new Vue({
        ...
        methods: {
          confirmSend: function confirmSend() {
            ...
            this.tipText = "正在发放";
            this.tipTag = true;
            axios.get("/index/admin/batch_send_coupon_by_phone", {
              params: {
        ...
        mounted: function mounted() {
          ...
          axios.get("/index/admin/get_coupon_batch_send").then(function (res) {
            ...
            _this2.phone = _this2.phoneData.replace(/\s+/g, " ").split(" ");
            _this2.$nextTick(function () {
              var coupon = _this2.$refs.couponSelected;
              _this2.couponItem = coupon.value;
              _this2.remain = _this2.couponList[_this2.couponItem].remain;
              _this2.coupon_id = _this2.couponList[_this2.couponItem].id;
            });
          });
        }
      });
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_6fdf05c4.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);