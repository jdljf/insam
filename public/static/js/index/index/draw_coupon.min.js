  ...
  function s(o, u) {
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      var vm = new Vue({
        ...
        methods: {
          drawCoupon: function drawCoupon() {
            var _this = this;

            if (!this.btnTag) {
              this.btnTag = true;
              axios.get("/index/index/receive_coupon_auto").then(function (res) {
        ...
        mounted: function mounted() {
          ...
          axios.get("/index/index/get_sys_coupon").then(function (res) {
            if (res.data.code == 200) {
              _this2.availableCoupon = res.data.data;
              if (_this2.availableCoupon.expire_time != null) {
                if (_this2.availableCoupon.expire_type == 2) {
                  _this2.start_time = _this2.availableCoupon.expire_time.start_time;
                  _this2.end_time = _this2.availableCoupon.expire_time.end_time;
                }
              }
            } else {
              _this2.tag = false;
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_d84ced92.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);