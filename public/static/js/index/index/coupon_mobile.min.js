...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var vm = new Vue({
        ...
        methods: {
          ...
          getData: function getData() {
            var that = this;
            axios.post('/index/index/get_coupon_list', {}).then(function (res) {
              console.log(res);
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_fb48c1a3.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);