...
(function e(t, n, r) {
  function s(o, u) {
        ...
        methods: {
          ...
          submitStyleEdit: function submitStyleEdit() {
            if (this.editBoxValue.price && this.editBoxValue.image) {
              axios.get("/index/index/edit_image", {
          ...
          getImageList: function getImageList() {
            ...
            axios.get("/index/index/get_image").then(function (res) {
              if (res.data) {
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_d1ad841e.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);