...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var vm = new Vue({
        ...
        mounted: function mounted() {
          ...
          axios.post('/index/index/get_my_design', {
            ...
            var resp = res.data;
            _this.designItem = resp.data;
            _this.designItem.forEach(function (element) {
              _this.designStyle.push(JSON.parse(element.style));
              _this.ctime.push(element.ctime);
            });
            _this.page++;
          });
        ...
        methods: {
          delete_design: function delete_design(designid) {
            var mymessage = confirm("确认删除设计?");
            if (mymessage == true) {
              axios.get("/index/index/delete_design", {
                params: {
                  design_id: designid
                }
              }).then(function (res) {
          ...
          initDesign: function initDesign() {
            var _this2 = this;

            var pageHeight = Math.max(document.body.scrollHeight, document.body.offsetHeight);
            var viewportHeight = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight || 0;
            var scrollHeight = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0;
            if (pageHeight - scrollHeight - viewportHeight < 50 && !this.loadingTag) {
              // 监测滚动条增加数据
              ...
              axios.post('/index/index/get_my_design', {
                ...
                response.data.forEach(function (el) {
                  _this2.designItem.push(el);
                });
                _this2.designItem.forEach(function (element) {
                  _this2.designStyle.push(JSON.parse(element.style));
                  _this2.ctime.push(element.ctime);
                });
                _this2.loadingTag = false;
                _this2.page++;
              });
            }
          }
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_bc02a7f7.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);