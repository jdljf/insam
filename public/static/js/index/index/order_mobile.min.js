...
(function e(t, n, r) {
  function s(o, u) {
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      var vm = new Vue({
        ...
        mounted: function mounted() {
          ...
          axios.post('/index/index/get_order_info', {}).then(function (res) {
            res = res.data;
            _this.orderItem = res.data;
            _this.orderItem.forEach(function (element) {
              _this.orderStyle.push(element.style);
              _this.ctime.push(element.ctime);
              _this.getStatus.push(element.status);
            });
          });
        },

        methods: {
          changeOrderStatus: function changeOrderStatus(status, orderId) {
            axios.get("/index/index/change_order_status", {
              params: {
                status: status,
                id: orderId
              }
    ...
    }).call(this, require("B3Wh1Y"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_de1fd902.js", "/");
  }, { "B3Wh1Y": 4, "buffer": 1 }] }, {}, [5]);